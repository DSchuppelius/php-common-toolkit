...
class Transaction {
    ...
    public function __construct(DateTimeImmutable|string $date,  DateTimeImmutable|string|null $valutaDate, float $amount, CreditDebit $creditDebit, CurrencyCode $currency, Reference $reference, ?string $purpose = null) {
