...
class WebLinkHelperTest extends BaseTestCase {
    ...
    public function test_is_url_with_valid_urls(string $url): void {
        $this->assertTrue(WebLinkHelper::isUrl($url));
    }

    #[DataProvider('invalidUrlProvider')]
    public function test_is_url_with_invalid_urls(?string $url): void {
    ...
    public function test_is_http_url(): void {
    ...
    public function test_add_query_params(): void {
    ...
    public function test_remove_query_params(): void {
        $this->assertEquals(
    ...
    public function test_resolve_relative(): void {
    ...
    public function test_belongs_to_domain(): void {
    ...
    public function test_is_online_with_invalid_url(): void {
    ...
    public function test_is_online_with_dns_only_check(): void {
    ...
    public function test_has_valid_dns(): void {
        // Bekannte Domains
