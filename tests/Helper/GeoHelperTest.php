...
final class GeoHelperTest extends TestCase {
    public function testValidatesCoordinates(): void {
    ...
    public function testCalculatesHaversineDistanceInKilometersAndMeters(): void {
    ...
    public function testCalculatesTrackLengthForAssociativeAndIndexedPoints(): void {
        $associative = [
    ...
    public function testRejectsInvalidTrackPoint(): void {
        $this->expectException(InvalidArgumentException::class);

        GeoHelper::trackLengthKm([['lat' => 91.0, 'lon' => 13.0]]);
    }

    public function testCalculatesBearing(): void {
    ...
    public function testCalculatesMidpointAcrossDateLine(): void {
    ...
    public function testCalculatesBoundingBox(): void {
    ...
    public function testRejectsEmptyBoundingBox(): void {
        $this->expectException(InvalidArgumentException::class);

        GeoHelper::boundingBox([]);
    }

    public function testConvertsE7Coordinates(): void {
    ...
    public function testFormatsBothCoordinateOrders(): void {
