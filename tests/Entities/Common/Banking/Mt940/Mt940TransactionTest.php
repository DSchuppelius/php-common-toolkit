...
namespace Tests\CommonToolkit\Entities\Common\Banking\Mt940;

use CommonToolkit\Entities\Banking\Mt940\{Reference, Transaction};
...
class Mt940TransactionTest extends BaseTestCase {
    ...
    public function testGetterMethodsReturnCorrectValues(): void {
        $this->markTestIncomplete('Die Implementierung von Transaction muss noch abgeschlossen werden.');
    ...
    public function testToMt940LinesGeneratesCorrectFormat(): void {
        $this->markTestIncomplete('Die Implementierung von Reference muss noch abgeschlossen werden.');
